namespace ME.ECS {
    ...
    public readonly struct RPCId : IComparable, IConvertible, IFormattable, IComparable<TName>, IEquatable<TName>, ISerializable {

        public readonly TType v; // Do not rename (binary serialization)

        private RPCId(TType value) {

            this.v = value;

        }
        
        private RPCId(SerializationInfo info, StreamingContext context) {
            
            this.v = info.GetInt32("v");
        ...
        // than throwing except in if input is invalid
        // 
        #if ECS_COMPILE_IL2CPP_OPTIONS
        [Unity.IL2CPP.CompilerServices.Il2CppSetOptionAttribute(Unity.IL2CPP.CompilerServices.Option.NullChecks, false),
         Unity.IL2CPP.CompilerServices.Il2CppSetOptionAttribute(Unity.IL2CPP.CompilerServices.Option.ArrayBoundsChecks, false),
